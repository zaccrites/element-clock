...
*/
#define IO_PIN_SHIFT_DATA            (1 << PA0)
#define IO_PIN_SHIFT_CLOCK           (1 << PA2)
#define IO_PIN_SHIFT_LATCH           (1 << PA3)
#define IO_PIN_SHIFT_CLEAR           (1 << PA1)
#define IO_PIN_ELEMENT_MODE_SWITCH   (1 << PA5)
#define IO_PIN_SPEED_BUTTON          (1 << PA4)
